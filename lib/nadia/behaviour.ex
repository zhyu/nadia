defmodule Nadia.Behaviour do
  ...
  @callback send_message(integer, binary, [{atom, any}]) :: {:ok, Message.t} | {:error, Error.t}
  ...
  @callback send_document(integer, binary, [{atom, any}]) :: {:ok, Message.t} | {:error, Error.t}
  @callback send_sticker(integer, binary, [{atom, any}]) :: {:ok, Message.t} | {:error, Error.t}
  ...
  @callback send_location(integer, float, float, [{atom, any}]) :: {:ok, Message.t} | {:error, Error.t}
  @callback send_venue(integer, float, float, binary, binary, [{atom, any}]) :: {:ok, Message.t} | {:error, Error.t}
  @callback send_contact(integer, binary, binary, [{atom, any}]) :: {:ok, Message.t} | {:error, Error.t}
  @callback send_chat_action(integer, binary) :: :ok | {:error, Error.t}
  @callback get_user_profile_photos(integer, [{atom, any}]) :: {:ok, UserProfilePhotos.t} | {:error, Error.t}
  ...
  @callback get_chat_administrators(integer | binary) :: {:ok, [ChatMember.t]} | {:error, Error.t}
  @callback get_chat_members_count(integer | binary) :: {:ok, integer} | {:error, Error.t}
  @callback get_chat_member(integer | binary, integer) :: {:ok, ChatMember.t} | {:error, Error.t}
  ...
  @callback edit_message_caption(integer | binary, integer, binary, [{atom, any}])  :: {:ok, Message.t} | {:error, Error.t}
  @callback edit_message_reply_markup(integer | binary, integer, binary, [{atom, any}])  :: {:ok, Message.t} | {:error, Error.t}
  @callback answer_inline_query(binary, [Nadia.Model.InlineQueryResult.t], [{atom, any}]) :: :ok | {:error, Error.t}
end
