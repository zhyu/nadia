  ...
  defmacro __using__(_opts) do
    quote location: :keep do
      ...
      @callback copy_messages(Client.t(), integer | binary, integer | binary, [integer], [
                  ...
                  {:ok, [MessageId.t()]} | {:error, Error.t()}
      @callback send_photo(integer, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_photo(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_audio(integer, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_audio(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_document(integer, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_document(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_sticker(integer, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_sticker(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_video(integer, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_video(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_voice(integer, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_voice(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_video_note(integer | binary, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_video_note(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_live_photo(
                  integer | binary,
      ...
      @callback send_animation(integer, binary | Nadia.InputFile.t(), [{atom, any}]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
      @callback send_animation(Client.t(), integer | binary, binary | Nadia.InputFile.t(), [
                  {atom, any}
                ]) ::
                  {:ok, Message.t()} | {:error, Error.t()}
